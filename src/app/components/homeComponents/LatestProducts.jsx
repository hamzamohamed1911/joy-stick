...
import latestProducts from "@/app/_constants"; 
...
const LatestProducts = () => {
  ...
  return (
    <section className="lg:max-w-screen-2xl w-full container mx-auto py-6 flex flex-col justify-center items-center p-4 space-y-8">
      <div className="gap-6">
